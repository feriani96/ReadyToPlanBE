...
export const sampleWithRequiredData: ITrainingCourse = {
  ...
  title: 'magenta',
  targetAudience: TargetAudience['ENSEIGNANTS'],
  studyClass: StudyClass['PRIMAIRE'],
...
export const sampleWithPartialData: ITrainingCourse = {
  ...
  targetAudience: TargetAudience['ENSEIGNANTS'],
  instructor: 'Pizza',
  studyClass: StudyClass['FORMATION'],
  level: Level['BEGINNER'],
...
export const sampleWithFullData: ITrainingCourse = {
  ...
  title: 'Awesome',
  summary: 'Handmade',
  targetAudience: TargetAudience['ETUDIANTS'],
  instructor: 'Architect SSL',
  studyClass: StudyClass['COLLEGE'],
...
export const sampleWithNewData: NewTrainingCourse = {
  ...
  targetAudience: TargetAudience['PROFESSIONNELS'],
  studyClass: StudyClass['LICENCE1'],
  level: Level['INTERMEDIATE'],
  locationType: LocationType['UNIVERSITY'],
  languages: Languages['FRENCH'],
  id: null,
