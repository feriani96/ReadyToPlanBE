...
describe('Enterprise Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'enterprise', component: EnterpriseComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.enterprises?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
